...
Go unit tests live next to the package they cover. They mock the WAF with `httptest` and do not start Docker. Local default is `go test ./...`. The `go.yml` PR Test job uses `go test -race -v ./...`.
